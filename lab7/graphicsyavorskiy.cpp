...
//ПОДСОЛНУХ
    QPixmap newImage2;
    if (!newImage2.load(QStringLiteral("C:\\Users\\79133\\QtProjects\\podsolnuh.png")))return;
...
//РЕДИС
    QPixmap newImage3;
    if (!newImage3.load(QStringLiteral("C:\\Users\\79133\\QtProjects\\redis.jpg")))return;
    ...
    if (!newImage.load(QStringLiteral("C:\\Users\\79133\\QtProjects\\vorona.jpg")))return;
